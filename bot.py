...
class bot():
	...
	def startup(self):
		self.nickname,self.user,self.host,self.realname = ('sjBot','sjBot','sjBot','Uptone Software')
		self.ident()
		self.main_loop()
		return 0
	...
	def ident(self):
		...
		self.send('USER ' + ' '.join((self.nickname, self.user, self.host, self.realname)))
		return 0
...
if __name__ == '__main__':
	...
	print('bot.py is an IRC bot class made by Sjc1000 for the use in sjBot also made by Sjc1000')
